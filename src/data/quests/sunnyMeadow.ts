...
import { tapCount, rand, pick } from '../generators'
...
export const buildSunnyMeadowQuests = (): Quest[] => [
  ...
  },
  {
    ...
    problems: Array.from({ length: 5 }, () => tapCount(pick(MEADOW_EMOJIS), rand(3, 9))),
  },
  {
    id: 'meadow-q3',
    index: 3,
    ...
    problems: Array.from({ length: 5 }, () => tapCount(pick(MEADOW_EMOJIS), rand(8, 14))),
  },
  {
    id: 'meadow-q4',
    index: 4,
    ...
    problems: Array.from({ length: 5 }, () => tapCount(pick(MEADOW_EMOJIS), rand(13, 20))),
  },
  {
    id: 'meadow-q5',
    index: 5,
    ...
    problems: Array.from({ length: 6 }, () => tapCount(pick(MEADOW_EMOJIS), rand(2, 20))),
  },
]
