...
import { optionsAround, nextId, rand, buildUnique } from '../generators'
...
export const buildCrystalCavesQuests = (): Quest[] => [
  {
    ...
    problems: buildUnique(5, () => tensAndOnes(rand(1, 9), rand(0, 9))),
  },
  {
    id: 'cave-q2',
    index: 2,
    ...
    problems: buildUnique(5, () => oneMore(rand(9, 99))),
  },
  {
    id: 'cave-q3',
    index: 3,
    ...
    problems: buildUnique(5, () => tenMore(rand(5, 99))),
  },
  {
    id: 'cave-q4',
    index: 4,
    ...
    problems: buildUnique(5, () => tensAndOnes(rand(1, 11), rand(0, 9))),
  },
  {
    id: 'cave-q5',
    index: 5,
    ...
    problems: [
      ...buildUnique(3, () => tensAndOnes(rand(1, 11), rand(0, 9))),
      ...buildUnique(2, () => oneMore(rand(9, 119))),
      ...buildUnique(3, () => tenMore(rand(5, 109))),
    ],
  },
]
